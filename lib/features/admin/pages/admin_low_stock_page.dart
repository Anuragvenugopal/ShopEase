...
class AdminLowStockPage extends StatefulWidget {
  const AdminLowStockPage({super.key});

  @override
  State<AdminLowStockPage> createState() => _AdminLowStockPageState();
}

class _AdminLowStockPageState extends State<AdminLowStockPage> {
