...
class AdminBarcodeScannerPage extends StatefulWidget {
  const AdminBarcodeScannerPage({super.key});

  @override
  State<AdminBarcodeScannerPage> createState() => _AdminBarcodeScannerPageState();
}

class _AdminBarcodeScannerPageState extends State<AdminBarcodeScannerPage> with SingleTickerProviderStateMixin {
