...
class AdminSkuSearchPage extends StatefulWidget {
  const AdminSkuSearchPage({super.key});

  @override
  State<AdminSkuSearchPage> createState() => _AdminSkuSearchPageState();
}

class _AdminSkuSearchPageState extends State<AdminSkuSearchPage> {
                                  ...
                                  Row(
                                    ...
                                    children: [
                                      Column(
                                        crossAxisAlignment: CrossAxisAlignment.start,
                                        children: [
                                          Text('Price: \$${product.price.toStringAsFixed(2)}', style: const TextStyle(fontSize: 12, fontWeight: FontWeight.bold)),
                                          const SizedBox(height: 2),
                                          Row(
                                            children: [
