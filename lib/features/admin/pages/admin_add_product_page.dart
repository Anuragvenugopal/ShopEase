...
class _AdminAddProductPageState extends State<AdminAddProductPage> {
  ...
  void _onSaveProduct() {
    if (_formKey.currentState!.validate()) {
      ...
      // Simulated saving latency
      Future.delayed(const Duration(milliseconds: 1500), () {
        if (mounted) {
          final rand = Random();
          final newProduct = DummyProduct(
            id: 'p${DummyData.products.length + rand.nextInt(100) + 9}',
            title: _titleController.text.trim(),
            description: _descriptionController.text.trim(),
            imageUrl: 'https://images.unsplash.com/photo-1523275335684-37898b6baf30?auto=format&fit=crop&w=600&q=80', // generic placeholder
          ...
          setState(() {
            DummyData.products.add(newProduct);
            _isLoading = false;
          });
