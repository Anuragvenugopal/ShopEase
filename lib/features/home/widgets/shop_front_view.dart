...
/// The shop-front feed tab — search bar, banner, categories,
/// deals bento, and trending products grid.
///
/// Previously was the private `_ShopFrontView` inside `home_screen.dart`.
class ShopFrontView extends StatelessWidget {
  ...
  /// Callback used to switch the bottom nav tab from within this view.
  /// Pass the tab index: 1 = Categories, 3 = Cart.
      ...
      child: SingleChildScrollView(
        ...
        child: Column(
          ...
          children: [
            ...
            const SizedBox(height: 100), // padding for bottom nav overlay
          ],
        ),
      ),
    );
